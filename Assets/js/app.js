...
function init() {
    ...
    d3.json("Assets/data/2008-2019_GradbySCH_v2.json").then((data) => {
...
function buildPanel(id) {
    d3.json("Assets/data/panel_level_info.json").then((data) => {
            ...
            annotations: [
                {
                    ...
                    xanchor: 'left',
                    yanchor: 'bottom',
                    text: `${selected_id[0].SCH_NAME}'s Graduation Trends`,
                    font: {
                        family: 'Arial',
                        size: 30,
                        color: 'rgb(37,37,37)'
...
function init_state() {
    ...
    // Building school information in panel ID_101_210
    d3.json("Assets/data/State_level_info_flipped.json").then((data) => {
...
d3.json("Assets/data/State_level_info.json").then((data) => {
